...
func (d BuffBatchReader) ReadCustomers(filePath string, batchSize int) (results chan []model.Customer) {
	// Buffered channel to store the results.
	results = make(chan []model.Customer, batchSize)
